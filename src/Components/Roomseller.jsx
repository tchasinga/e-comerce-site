...
import Second from "../Projects/Objectfour";
            ...
            <div className="">
                ...
                <div className='newproductgrid'>
                    {products.map((newdata) => {
                        return (
                            <div className="newproductgriditem p-1 flex flex-col mb-1  justify-center bg-gray-100 " key={newdata.id}>
                                <div className='text-white codecolor'>
                                    <h1 className='bg-red-500 w-20 m-1 rounded-sm   text-xs font-semibold pl-1 mt-3'>{newdata.time}</h1>
                                </div>
                                <div className="newproductgriditemimg">
                                    <img src={newdata.myImage} alt="newgridImg" />
                                </div>
                                <div className="p-2">
                                    <div className="newproductgriditemname mt-2">
                                        <h1 className='text-sm font-medium'>{newdata.name}</h1>
                                    </div>
                                    <div className="newproductgriditemviewer">
                                        <h1 className='text-xs  p-0 '>{newdata.viewer}</h1>
                                    </div>
                                    <div className="newproductgriditemprice">
                                        <h1 className='font-semibold'>{newdata.price}</h1>
                                    </div>
                                </div>
                            </div>
                        );
