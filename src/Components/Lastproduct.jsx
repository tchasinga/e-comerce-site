...
const Lastproduct = () => {
  return (
    <div className="newproduct mt-7">
      <div className="">
        <p className="text-sm mb-4 cursor-pointer font-semibold">
          Available shoes is {newlastproduct.length}
        </p>
        <div className="newproductgrid">
          {newlastproduct.map((jordan) => {
            return (
              <div
                className="newproductgriditem p-1 flex flex-col mb-1  justify-center bg-gray-100 "
                key={jordan.id}
              >
